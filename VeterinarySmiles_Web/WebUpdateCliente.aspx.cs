            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (id > 0)
                    {
                        ...
                        txtUser.Text = v.UserName.ToString();
            ...
            try
            {
                ...
                */
                ...
                //{
                    ...
                    User v = new User(txtUser.Text, txtContrsenia.Text, float.Parse(txtPeso.Text), float.Parse(txtCM.Text), selGradoDiabetes.SelectedValue);
