<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCajero.Master" AutoEventWireup="true" CodeBehind="WebMuestraPlato.aspx.cs" Inherits="VeterinarySmiles_Web.WebMuestraPlato" %>
...
<form id="form1" runat="server">
    ...
    <div class="form-box">
        ...
        <section class="content-header">
            <h2 style="text-align:center">Lista de Platos que componen este menu </h2>
        </section>
