<%@ Page Title="Tipo De Producto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebAdmTypeProduct.aspx.cs" Inherits="VeterinarySmiles_Web.WebAdmTypeProduct" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-box">
            ...
            <section class="content-header">
                <h1 style="text-align:center">Administracion de Tipo Producto</h1>
            </section>
